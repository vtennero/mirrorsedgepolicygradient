...
#### Selection Criteria
The 40% frequency was chosen based on comparison with a 15% baseline, which resulted in insufficient roll usage (0.69%). The 40% value balances style learning with functional behavior preservation; alternative values could be explored in future work.
...
![Figure 7: Training Curve showing cumulative reward vs training steps](training_curve.pdf)

![Figure 6: Policy Loss and Value Loss over training](loss.pdf)

![Figure 4: Entropy over training](entropy.pdf)
...
![Figure 5: Episode Length over training](episode_length_dist.pdf)

![Figure 3: Distance Traveled Distribution](distance.pdf)

### Action Distribution and Behavior

![Figure 1: Action Distribution Over Time (PRIMARY GRAPH for this section)](action_distribution.pdf)
