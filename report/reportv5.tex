...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{training_curve.pdf}
    \caption{Training curve showing cumulative reward vs training steps}
    \label{fig:training_curve}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{loss.pdf}
    \caption{Policy loss and value loss over training}
    \label{fig:loss}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{entropy.pdf}
    \caption{Entropy over training}
    \label{fig:entropy}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{episode_length_dist.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{distance.pdf}
    \caption{Distance traveled distribution}
    \label{fig:distance}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{action_distribution.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{comparative_analysis.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{roll_usage.pdf}
    \caption{Roll usage vs style episode frequency}
    \label{fig:roll_usage}
\end{figure}
